...
if (isset($_POST["submit"])) {
    ...
    if ($upload_error !== 0) {
        $arr_upload_error = [
            ...
            2 => '- Ukuran file foto melewati batas maksimal 1MB',
        ...
        if (file_exists($file_path)) {
            $error_message .= "- File dengan nama sama sudah ada di 
            server <br>";
        }
...
<head>
    ...
    <meta name="description" content="Halaman praktikum modul 8 mata kuliah pemrograman web di program 
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="student_name" value="<?=
                                $student_name ?>" size="20" placeholder="Nama Anda">
                        </td>
                    </tr>
                    <tr>
                        <td>No Induk Mahasiswa (NIM)*</td>
                        <td>:</td>
                        <td><input type="text" name="student_number" value="<?=
                            $student_number ?>" size="20" placeholder="NIM Anda"></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top;">Alamat Mahasiswa**</td>

                        <td style="vertical-align: top;">:</td>
                        <td><textarea name="student_address" cols="30" rows="5" placeholder="Alamat Anda"><?= $student_address
                            ?></textarea></td>
                    </tr>
                    <tr>
                        <td>Tanggal Lahir*</td>
...
selected>$i</option>";
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="url" name="student_website" value="<?=
                                $student_website ?>" size="40" placeholder="URL Website Anda">
                        </td>
                    </tr>
                </table>
            </fieldset>
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>Email*</td>
                        <td>:</td>
                        <td><input type="email" name="student_email" value="<?=
                            $student_email ?>" size="20" placeholder="Email Anda"></td>
                    </tr>
                    <tr>
                        <td>Username*</td>
                        <td>:</td>
                        <td><input type="text" name="student_username" value="<?=
                            $student_username ?>" size="20" placeholder="Username Anda"></td>
                    </tr>
                    <tr>
                        <td>Password*</td>
                        <td>:</td>
                        <td><input type="password" name="student_password" value="<?=
                            $student_password ?>" size="20" placeholder="Password Anda"></td>
                    </tr>
                    <tr>
                        <td>Konfirmasi Password*</td>
                        <td>:</td>
                        <td><input type="password" name="student_password_confirmation" value="<?=
                            $student_password_confirmation ?>" size="20" placeholder="Password Anda"></td>
                    </tr>
                </table>
            </fieldset>
            <br>
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <input type="checkbox" name="student_skill_html" value="html" id="html"
                                <?= $student_skill_html
                                    ?>><label for="html">HTML</label>
                            <input type="checkbox" name="student_skill_css" value="css" id="css" <?= $student_skill_css
                                ?>><label for="css">CSS</label>
                            <input type="checkbox" name="student_skill_js" value="javascript" id="javascript"
                                <?=
                                    $student_skill_js ?>><label for="javascript">Javascript</label>
                            <input type="checkbox" name="student_skill_php" value="php" id="php" <?= $student_skill_php
                                ?>><label for="php">PHP</label>
                            <input type="checkbox" name="student_skill_mysql" value="mysql" id="mysql"
                                <?= $student_skill_mysql ?>><label for="mysql">MySQL</label>
                            <input type="checkbox" name="student_skill_laravel" value="laravel" id="laravel"
                                <?= $student_skill_laravel ?>><label for="laravel">Laravel</label>
                            <input type="checkbox" name="student_skill_react_native" value="react_native"
                                id="react_native" <?= $student_skill_react_native
                                    ?>><label for="react_native">React
                                Native</label>
                        </td>
                    </tr>
                </table>
